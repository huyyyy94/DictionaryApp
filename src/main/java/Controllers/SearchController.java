...
public class SearchController implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        list = Backend.dbSearchWord("'bell%'", tableNameInSearchGui);
    ...
    public void onActionSearchBtn() {
        list = Backend.dbSearchWord("'" + searchField.getText().toLowerCase().trim() + "%'",
    ...
    public void onActionConfirmBtn() {
        ...
        if (!descriptionEdited.equals("")) {
            ...
            Backend.dbUpdateWord(descriptionEdited, word, tableNameInSearchGui);
    ...
    public void onActionDeleteWord() {
        ...
        if (selectedWord != null) {
            String word = selectedWord.getWordTarget();
            Backend.dbDeleteWord(word, tableNameInSearchGui);
    ...
    public void onActionSpeakerBtn() {
        Word selectedWord = listResult.getSelectionModel().getSelectedItem();
        if (selectedWord != null) {
            Backend.textToSpeech(selectedWord.getWordTarget());
        }
    }
